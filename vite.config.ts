...
export default defineConfig({
  plugins: [
    ...
    tailwindcss(),
    {
      ...
      closeBundle() {
        // background.js and content.js are bundled separately
        // (vite.config.background.ts, vite.config.content.ts) so their npm
        // deps get inlined; everything else is copied verbatim.
        const files = [
          "manifest.json",
          "options.html",
          "options.js",
